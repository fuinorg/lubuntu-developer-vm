pipeline {
    ...
    environment {
        ...
        VBOX_URL = 'https://download.virtualbox.org/virtualbox/6.1.4/virtualbox-6.1_6.1.4-136177~Ubuntu~bionic_amd64.deb'
    }
    stages {
        stage('Setup Build') { 
            steps {
