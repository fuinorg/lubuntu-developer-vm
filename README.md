...
## Download
You can also download the final **Lubuntu Developer VM (64 Bit)** image (uncompressed ~4.5 GB) here: 
* [fuin.org](https://www.fuin.org/vm/) (~1.7 GB / 64 bit OS / vbx = VirtualBox / vmw = VMware Workstation)
